...
**A learner acting on their own behalf.** D55 imposes no recognition requirement on a learner acting personally, and adds no precondition to a learner's own act.

**The underlying question is not determined, and D55 does not determine it.** Whether a learner personally holds the authority to override, revoke or ratify a delegated choice is not answered by the presently available constitutional record. D24 §16 states that this question “requires a separate authority decision where D1–D24 do not determine the answer”, and no decision in the available record from D25 to D54 supplies that determination. D55 records this openly rather than attributing an answer to the chain, and **D55 does not grant, deny, condition, withhold or infer that authority.** The unavailability of standalone D1–D19 specification text is a limitation on the record under §16.1 and is not treated here as licence to supply what those decisions may or may not require.

**D55 governs the consequence side only.** Where a learner-side override, revocation or ratification act is separately authorised under the constitution, D55 governs the constitutional treatment of that authorised act and confines its effect as set out in §7, §8 and §9. Where no such authority is separately established, no effect follows on the delegated choice. That outcome reflects an unresolved constitutional question, not a determination by D55 about the learner or about the delegated choice, and it must never be described as the learner failing to be recognised.
...
|---|---|
| Whether, and in what circumstances, a learner personally holds the underlying authority in respect of a delegated choice | Not determined by the available constitutional record, per D24 §16, and not determined by D55; D55 governs the effect only and imposes no recognition requirement on a learner acting on their own behalf. |
